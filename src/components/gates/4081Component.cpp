...
const std::unordered_map<std::size_t, std::pair<std::string, std::size_t>>
    nts::components::IC4081Component::INTERNAL_PIN_BINDS = {
...
nts::components::IC4081Component::IC4081Component()
...
void nts::components::IC4081Component::simulate(const std::size_t tick)
{
...
nts::Tristate nts::components::IC4081Component::compute(const std::size_t pin)
{
    switch (pin)
    {
        case 3:
